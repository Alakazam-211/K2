...
export const ENABLE_STEPS: { id: string; label: string }[] = [
  ...
  { id: 'config', label: 'Write configuration' },
  { id: 'unit', label: 'Install systemd unit' },
  { id: 'start', label: 'First start' },
  { id: 'admin-password', label: 'Capture bootstrap credentials' },
  ...
  { id: 'rotate-admin', label: 'Rotate admin password' },
  { id: 'setup-listener-off', label: 'Disable setup listener' },
