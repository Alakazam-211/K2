// Published drawer — APP-LEVEL `publish_services_changed` dispatch through
// the REAL session-events module (the tunnel_subdomains_changed pattern).
//
// Pins, against a fake WebSocket at the transport boundary:
//   - onPublishServicesChanged fires with the carried projectId
...
describe('onPublishServicesChanged (app-level publish_services_changed dispatch)', () => {
  it('fires the registered callback with the carried projectId', async () => {
