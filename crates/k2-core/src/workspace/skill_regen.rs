...
fn compose_agents_md(project_path: &str) -> String {
    ...
    let mut out = format!(
        "# {project_name}\n\n\
         <!-- GENERATED by K2 from system sources (AGENT.md + PROJECT.md + Tooling) \
         and optional context layers. Edit the source files or use `k2 agent context`, \
         not this one — K2 regenerates AGENTS.md and the harness mirrors \
...
mod tests {
    ...
    fn k2_cli_loadable_skill_uses_new_brand_and_no_deprecated_verbs() {
        ...
        // Context hamburger (0.40.64): lean always-on stack management.
        assert!(
