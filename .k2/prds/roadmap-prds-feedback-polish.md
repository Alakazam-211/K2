...
| **Air-gap flag + LAN listen** (MasterControl / Ryan) | **Shipped 0.40.109**; MC Caddy LAN recipe **0.40.110** | `.k2/prds/prd-air-gap-and-lan-listen-v1.md` · review `prd-air-gap-and-lan-listen-v1-review.md` · runbook `.k2/prds/runbook-airgap-linux-image-v1.md` · `docs/caddy-airgap-lan.Caddyfile` · wiki Feature - Air-Gap When Tunnel Off |
