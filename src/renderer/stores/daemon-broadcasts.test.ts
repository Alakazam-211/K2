...
//
// Each renderer consumer (assistant / active-agents / CompanionSection)
// drops its `setInterval`/`setTimeout` poll
...
// The review-queue (#675.3) cutover suite was deleted in 0.40.31 together
// with `stores/review-queue.ts` (the Review Queue UI is gone; ⌘J Running
// Agents is the surviving surface).
