...
assert_contains "files on docs not anna" "$skins_out" "Files on Documents does not grant files on Anna"
assert_contains "role room example" "$skins_out" "k2 skin role room dentist anna"
...
assert_contains "tickets on docs not anna" "$skins_out" "tickets on Documents does not grant tickets on Anna"
...
assert_contains "wiki on docs not anna" "$skins_out" "wiki on Documents does not grant wiki on Anna"
...
assert_contains "store on docs not anna" "$skins_out" "store on Documents does not grant store on Anna"
